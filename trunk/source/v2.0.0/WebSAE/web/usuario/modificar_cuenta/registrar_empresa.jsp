...
<div style="width:450px; border: 1px maroon; margin:10px;">
    <div>
        <form dojoType="dijit.form.Form" class="form-suscripcion" id="empresa" name="empresa">
            <fieldset>
                ...
                <label for="txt_nombre_empresa"><fmt:message key="us.empresa_universidad" /></label>
                ...
                <label for="cmb_ciudad_empresa"><fmt:message key="us.ciudad" /></label>
                <input name="cmb_ciudad_empresa" id="cmb_ciudad_empresa" dojoType="dijit.form.FilteringSelect"
                       invalidMessage="<fmt:message key="ge.solo_valores_lista" />"
                       promptMessage="<fmt:message key="ge.necesita_valor" />"
                       value="Guayaquil" store="ciudad_empresaStore" searchAttr="nombre" required="true" />
                <span class="lblasterisco"> (*)</span>
                <div class="clearthefloats" />

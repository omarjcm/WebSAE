...
<div id="div_material" dojoType="dijit.Dialog" title="<fmt:message key="adm.materiales" />" style="width:400px;">
    <form dojoType="dijit.form.Form" class="form-suscripcion" id="frm_material" name="frm_material" action="">
        <div id="div_form">
            ...
            <label class="info_modificar"><fmt:message key="ge.precio2" />:</label>
            ...
            <div class="botones_administracion">
                <button id="btn_registrar" dojoType="dijit.form.Button" onclick="accion_material('registrar');" class="div_form" style="margin-left:50px;">

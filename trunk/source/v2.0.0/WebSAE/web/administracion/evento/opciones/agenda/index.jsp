...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><fmt:message key="ge.tituloProyecto" /> - <fmt:message key="adm.agenda" /></title>
        ...
        <div id="div_body_general">
            ...
            <div id="div_informacion_admin">
                <div id="opcion-menu">
                    ...
                    <div id="opcion-menu-item">
                        <a href="javascript:popup_registrar_agenda();"><img src="/websae/images/nuevo.png" height="55px" alt="" /><br /><fmt:message key="ge.nuevo" /></a>
                    </div>
                ...
                <div id="div_form">
                    ...
                    <div class="titulo"><fmt:message key="adm.agenda" /></div>

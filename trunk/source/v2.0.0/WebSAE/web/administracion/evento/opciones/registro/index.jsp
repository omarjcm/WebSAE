                ...
                <div id="div_informacion_admin">
                    ...
                    <div id="div_form">
                        ...
                        <div style="margin: 0pt auto; text-align: center; width: 180px; text-align:center;">
                            <a href="/websae/administracion/evento/opciones/registro/registro_pendiente/index.jsp">
                                <div style="width:150px; margin: 10px; padding: 10px; border:1px dotted silver;" onmouseover="style.backgroundColor='#EEEFFF';" onmouseout="style.backgroundColor='#FFFFFF'">
                                    <img src="/websae/images/aprobar_descuento.png" alt="" width="50px" /><br />
                                    Registros Pendientes
                                </div>
                            </a>
                            <!--a href="/websae/administracion/evento/opciones/registro/usuario_registrado/index.jsp">
                                <div style="width:150px; margin: 10px; padding: 10px; border:1px dotted silver;" onmouseover="style.backgroundColor='#EEEFFF';" onmouseout="style.backgroundColor='#FFFFFF'">
                                    <img src="/websae/images/usuarios_registrados.png" alt="" width="50px" /><br />

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="yui-skin-sam tundra" onload="inicializar('${lang}','${param.id_categoria}')">
            ...
            <div id="div_informacion_admin">
                <div id="opcion-menu">
                    <div id="opcion-menu-item">
                        <a href="/websae/administracion/evento/opciones/precio/index.jsp"><img src="/websae/images/regresar.png" height="55px" alt="" /><br /><fmt:message key="ge.regresar" /></a>
                    </div>
                    <div id="opcion-menu-item">

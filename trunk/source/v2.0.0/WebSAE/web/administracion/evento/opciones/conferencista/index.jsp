                ...
                <div id="div_informacion_admin">
                    ...
                    <div id="div_form">
                        ...
                        <jsp:include page="/administracion/usuario/buscar_usuario.jsp">
                            <jsp:param name="titulo" value="adm.conferencista" />
                            <jsp:param name="tipo" value="conferencista_usuario" />
                        </jsp:include>
                        <jsp:include page="conferencista.jsp" />
                        <div class="clearthefloats"></div><br />
                    </div>
                    <div id="tbl_conferencistas" style="width:385px; margin:0 auto;"></div>
                </div>
            </div>
            <div class="clearthefloats"></div>

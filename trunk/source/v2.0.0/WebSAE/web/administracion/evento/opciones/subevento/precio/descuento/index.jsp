...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><fmt:message key="ge.tituloProyecto" /> - <fmt:message key="adm.descuento" /></title>
    ...
    <body class="yui-skin-sam tundra" onload="inicializar('${lang}','${param.id_categoria}','${param.id_subevento}')">
        <div id="div_body_general">
            ...
            <div id="div_informacion_admin">
                ...
                <div id="div_form">
                    ...
                    <div id="subtitulo_categoria" class="subtitulo-principal"></div>
                    <div class="titulo"><fmt:message key="adm.descuento" /></div>
                    <div id="tbl_descuentos" style="width:310px; margin:0 auto;"></div>
                    <jsp:include page="descuento.jsp" />
                    <!--jsp:include page="horario.jsp" /-->

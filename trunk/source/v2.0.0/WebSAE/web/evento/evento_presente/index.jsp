...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><fmt:message key="ge.tituloProyecto" /> - <fmt:message key="us.eventos_presentes" /></title>
            ...
            <div id="div_contenedor_admin">
                <div id="div_info">
                    <div class="div_menu_admin_titulo">
                        <fmt:message key="us.eventos_presentes" />
                    </div>
                    <div class="div_menu_descripcion">
                        Aquí podrá encontrar todos los Eventos que están pronto a realizarse...
                    </div>
                </div>
                <jsp:include page="/vistas/info_usuario.jsp" />
                <div id="ubicacion">
                    <span class="ubicacion"><fmt:message key="pistas.ud_esta_en" />:</span> <span class="ubicacion"><fmt:message key="us.eventos_presentes" /></span>
                </div>
                <div id="div_informacion_admin">
                    <div id="div_form">
                        <div class="titulo"><fmt:message key="us.eventos_presentes" /></div>
                        <div id="tbl_eventos_presentes" style="width:565px; margin:0 auto 0 auto;"></div>
                    </div>
                </div>
            </div>

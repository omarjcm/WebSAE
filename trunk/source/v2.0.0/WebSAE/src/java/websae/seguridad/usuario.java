...
public class usuario implements Filter {
	...
	if (debug) log("usuario:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("usuario:DoAfterProcessing");
	...
	*/
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("usuario:Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("usuario()");
